...
namespace HK_Face {
    ...
    public class CHCNetSDK {
        ...
        **************************************************/
        ...
        //public const int DVR = 1;   //尚未定义的DVR类型  
        //public const int ATMDVR = 2;    //ATM DVR 
        //public const int DVS = 3;   //DVS  
        //public const int DEC = 4;   //6001D  
        //public const int ENC_DEC = 5;   //6001F  
        ...
        //public const int DVR_HS_S = 17; //8000HS-S  
        //public const int ATMDVR_S = 18; //ATM-S  
        public const int DVR_7000H = 19;    //7000H系列  
        //public const int DEC_MAT = 20;  //多路解码器  
        //public const int DVR_MOBILE = 21;   //mobile DVR
        //public const int DVR_HD_S = 22; //8000HD-S 
        //public const int DVR_HD_SL = 23;    //8000HD-SL  
        ...
        //public const int DVS_HW = 26;   //6000HW  
        //public const int DS630X_D = 27; //多路解码器  
        public const int DS640X_HD = 28;    //640X高清解码器  
        public const int DS610X_D = 29; //610X解码器  
        //public const int IPCAM = 30;    //网络摄像机  
        //public const int MEGA_IPCAM = 31;   //高清网络摄像机  
        //public const int IPCAM_X62MF = 32;  //X62MF系列摄像机  
        public const int ITCCAM = 35;   //智能交通摄像机  
        public const int IVS_IPCAM = 36;    //智能分析高清网络摄像机(人脸抓拍机)  
        public const int ZOOMCAM = 38;  //一体机  
        //public const int IPDOME = 40;   //IP标清快球  
        //public const int IPDOME_MEGA200 = 41;   //IP 200万高清快球 
        //public const int IPDOME_MEGA130 = 42;   //IP 130万高清快球 
        public const int TII_IPCAM = 44;    //红外热成像摄像机  
        //public const int IPMOD = 50;    //IP 模块 
        public const int TRAFFIC_YTDOME = 51;   //交通智能云台（不带雷达测速）  
        public const int TRAFFIC_RDDOME = 52;   //交通智能云台（带雷达测速）  
        public const int IDS6501_HF_P = 60; //6501 车牌识别 
        public const int IDS6101_HF_A = 61; //智能ATM  
        public const int IDS6002_HF_B = 62; //双摄像机跟踪：DS6002-HF/B  
        public const int IDS6101_HF_B = 63; //行为分析：DS6101-HF/B  
        //public const int IDS52XX = 64;  //智能分析仪  
        public const int IDS90XX = 65;  //9000智能  
        public const int IDS8104_AHL_S_HX = 66; //海鑫人脸识别 ATM 
        public const int IDS8104_AHL_S_H = 67;  //私有人脸识别 ATM 
        public const int IDS91XX = 68;  //9100智能  
        public const int IIP_CAM_B = 69;    //智能行为IP摄像机  
        public const int IIP_CAM_F = 70;    //智能人脸IP摄像机  
        //public const int DS71XX_H = 71; //DS71XXH_S 
        //public const int DS72XX_H_S = 72;   //DS72XXH_S  
        //public const int DS73XX_H_S = 73;   //DS73XXH_S  
        public const int DS72XX_HF_S = 74;  //DS72XX_HF_S  
        public const int DS73XX_HFI_S = 75; //DS73XX_HFI_S  
        //public const int DS76XX_H_S = 76;   //DS76XX_H_S  
        public const int DS76XX_N_S = 77;   //DS76XX_N_S  
        public const int DS_TP3200_EC = 78; //机柜智能检测仪  
        //public const int DS81XX_HS_S = 81;  //DS81XX_HS_S  
        //public const int DS81XX_HL_S = 82;  //DS81XX_HL_S  
        //public const int DS81XX_HC_S = 83;  //DS81XX_HC_S  
        //public const int DS81XX_HD_S = 84;  //DS81XX_HD_S  
        ...
        //public const int DS91XX_HF_S = 91;  //DS91XX_HF_S  
        //public const int DS91XX_HD_S = 92;  //91XXHD-S(MD)  
        public const int IDS90XX_A = 93;    //9000智能 ATM 
        public const int IDS91XX_A = 94;    //9100智能 ATM 
        public const int DS95XX_N_S = 95;   //DS95XXN-S NVR 
        public const int DS96XX_N_SH = 96;  //DS96XXN-SH NVR 
        public const int DS90XX_HF_SH = 97; //DS90XX_HF_SH  
        public const int DS91XX_HF_SH = 98; //DS91XX_HF_SH  
        public const int DS_65XXHC = 105;   //65XXHC DVS 
        public const int DS_65XXHC_S = 106; //65XXHC-SATA DVS 
        public const int DS_65XXHF = 107;   //65XXHF DVS 
        public const int DS_65XXHF_S = 108; //65XXHF-SATA DVS 
        public const int DS_6500HF_B = 109; //65 rack DVS
        public const int IVMS_6200_C = 110; //iVMS-6200(/C) 客流量统计 
        public const int IVMS_6200_B = 111; //IVMS_6200_B 行为分析 
        public const int DS_72XXHV_ST15 = 112;  //72XXHV_ST15 DVR 
        public const int DS_72XXHV_ST20 = 113;  //72XXHV_ST20 DVR 
        public const int IVMS_6200_T = 114; //IVMS-6200(/T)  
        public const int IVMS_6200_BP = 115;    //IVMS-6200(/BP)  
        public const int DS_81XXHC_ST = 116;    //DS_81XXHC_ST  
        public const int DS_81XXHS_ST = 117;    //DS_81XXHS_ST  
        public const int DS_81XXAH_ST = 118;    //DS_81XXAH_ST  
        public const int DS_81XXAHF_ST = 119;   //DS_81XXAHF_ST  
        public const int DS_66XXDVS = 120;  //DS_66XXDVS  
        public const int DS_19AXX = 142;    //通用报警主机类产品  
        public const int DS_19CXX = 144;    //自助银行报警主机  
        public const int DS_19DXX = 145;    //动环监控报警主机  
        public const int DS_19XX = 146; //1900系列报警主机  
        public const int DS_19SXX = 147;    //视频报警主机  
        public const int DS_1HXX = 148; //ATM防护舱控制器  
        public const int DS_PEAXX = 149;    //紧急求助报警产品  
        public const int DS_19DXX_S = 152;  //视频动环监控主机  
        public const int DS_C10H = 161; //多屏控制器  
        public const int DS_C10N_BI = 162;  //BNC处理器  
        public const int DS_C10N_DI = 163;  //RGB处理器  
        public const int DS_C10N_SI = 164;  //码流处理器  
        public const int DS_C10N_DO = 165;  //显示处理器  
        public const int DS_C10N_SERVER = 166;  //分布式服务器  
        public const int IDS_8104_AHFL_S_H = 171;   //8104ATM  
        public const int IDS_65XX_HF_A = 172;   //65 ATM 
        public const int IDS90XX_HF_RH = 173;   //9000 智能RH 
        public const int IDS91XX_HF_RH = 174;   //9100 智能RH设备 
        public const int IDS_65XX_HF_B = 175;   //65 行为分析 
        public const int IDS_65XX_HF_P = 176;   //65 车牌识别 
        public const int IVMS_6200_F = 177; //IVMS-6200(/F)人脸分析仪  
        public const int IVMS_6200_F_S = 179;   //IVMS-6200(/F_S)人脸后检索分析仪  
        public const int DS90XX_HF_RH = 181;    //DS90XX_HF_RH  
        public const int DS91XX_HF_RH = 182;    //9100 RH设备 
        public const int DS78XX_S = 183;    //78系列设备  
        public const int DS81XXHW_S = 185;  //DVR_81XXHW_S  
        public const int DS81XXHW_ST = 186; //DVR_81XXHW_ST  
        public const int DS91XXHW_ST = 187; //DVR_91XXHW_ST  
        public const int DS91XX_ST = 188;   //DVR_91XX_ST  
        public const int DS81XX_ST = 189;   //DVR_81XX_ST  
        public const int DS81XXH_ST = 190;  //DS81XXHDI_ST,DS81XXHE_ST  
        public const int DS73XXH_ST = 191;  //DS73XXHI_ST  
        public const int DS81XX_SH = 192;   //审讯81SH，81SHF  
        public const int DS81XX_SN = 193;   //审讯81SNL  
        public const int DS96XXN_ST = 194;  //NVR：DS96xxN_ST  
        public const int DS86XXN_ST = 195;  //NVR：DS86xxN_ST  
        public const int DS80XXHF_ST = 196; //DS80xxHF_ST  
        public const int DS90XXHF_ST = 197; //DS90xxHF_ST  
        public const int DS76XXN_ST = 198;  //NVR：DS76xxN_ST  
        public const int DS_9664N_RX = 199; //NVR：DS-9664N-RH、DS-9664N-RT  
        public const int ENCODER_SERVER = 200;  //编码卡服务器  
        public const int DECODER_SERVER = 201;  //解码卡服务器  
        public const int PCNVR_SERVER = 202;    //PCNVR存储服务器  
        public const int CVR_SERVER = 203;  //CVR  
        public const int DS_91XXHFH_ST = 204;   //高清DVR：DS_91xxHFH_ST  
        public const int DS_66XXHFH = 205;  //66高清编码器  
        public const int TRAFFIC_TS_SERVER = 210;   //终端服务器  
        public const int TRAFFIC_VAR = 211; //视频分析记录仪  
        public const int IPCALL = 212;  //IP可视对讲主机  
        public const int DS64XXHD_T = 701;  //64-T高清解码器  
        public const int DS_65XXD = 703;    //65万能解码器  
        public const int DS63XXD_T = 704;   //63-T标清解码器  
        public const int DS_64XXHD_S = 706; //DS-64xxHD-S高清解码器  
        public const int DS_68XXT = 707;    //多功能视音频转码器  
        public const int DS_65XXD_T = 708;  //65D-T万能解码器 
        public const int DS_D20XX = 750;    //LCD屏幕解码卡  
        public const int DS_C50S = 751; //SDI矩阵  
        public const int DS_D50XX = 752;    //LCD屏幕解码卡  
        public const int DS_65VMXX = 770;   //视频会议服务器  
        public const int DS_65VTXX = 771;   //视频会议终端  
        public const int DS_65VTA = 772;    //视频会议一体式终端  
        public const int DS_K260X = 850;    //门禁主机 
        public const int DS_K1T201X = 851;  //指纹一体机  
        public const int DS_K280X = 852;    //经济型门禁主机  
        public const int DS_K1T80X = 854;   //经济型门禁一体机  
        public const int RAC_6X00 = 856;    //汉军指纹门禁一体机  
        public const int DS_K2602_AX = 857; //人员通道主机  
        public const int DS_K1T803F = 858;  //经济型指纹门禁产品  
        public const int DS_K2700 = 859;    //分布式三层架构门禁主机  
        public const int DS_K270X = 860;    //分布式三层架构就地控制器  
        public const int DS_K1T500S = 861;  //视屏门禁一体机  
        public const int DS_K1A801F = 862;  //经济型指纹门禁产品 
        public const int DS_K1T600X = 863;  //人脸识别门禁一体机  
        public const int DS_K22X = 864; //梯控主控制器  
        public const int DS_K2M0016AX = 865;    //梯控分控制器  
        public const int DS_K1201X = 866;   //项目型指纹读卡器  
        public const int DS_K560XX = 870;   //立式/台式智能身份识别终端  
        public const int DS_6800M = 900;    //68M合码器  
        public const int DS_68NTH = 901;    //信息发布主机  
        public const int DS_D60S = 902; //信息发布服务器  
        public const int DS_D10 = 931;  //背投显示设备  
        public const int DS_3K0X_NM = 951;  //光纤收发器  
        public const int DS_3E2328 = 952;   //百兆交换机  
        public const int SCREEN_LINK_SERVER = 971;  //屏幕服务器  
        public const int DS_D51OPSXX = 972; //OPS电脑盒  
        public const int IP_PTSYS_MEGA200 = 1001;   //IP 200万一体化云台 
        public const int IPCAM_FISHEYE = 1002;  //鱼眼摄像机  
        public const int IPCAM_BINOCULAR = 1004;    //双目摄像机  
        public const int TRAFFIC_ECT = 1400;    //出入口终端服务器  
        public const int TRAFFIC_PARKING_SERVER = 1401; //停车场服务器  
        public const int TRAFFIC_TME = 1402;    //TME出入口控制机  
        public const int DS90XXHW_ST = 2001;    //混合DVR：DS90XXHW_ST  
        public const int DS72XXHX_SH = 2002;    //DS-72xxHV-SH，DS-72xxHF-SH  
        public const int DS_92XX_HF_ST = 2003;  //DS-92XXHF-ST  
        public const int DS_91XX_HF_XT = 2004;  //Netra DVR: DS-91xxHF-XT
        public const int DS_90XX_HF_XT = 2005;  //Netra 混合DVR: DS-90xxHF-XT
        public const int DS_73XXHX_SH = 2006;   //Netra DVR: DS-73xxHX-SH
        public const int DS_72XXHFH_ST = 2007;  //Netra DVR: DS-72xxHFH-ST
        public const int DS_67XXHF_SATA = 2008; //DVS: DS-67xxHF-SATA 
        public const int DS_67XXHW = 2009;  //DVS: DS-67xxHW 
        public const int DS_67XXHW_SATA = 2010; //DVS: DS-67xxHW-SATA 
        public const int DS_67XXHF = 2011;  //DVS: DS-67xxHF 
        public const int DS_72XXHF_SV = 2012;   //DVR: DS-72xxHF-SV 
        public const int DS_72XXHW_SV = 2013;   //DVR: DS-72xxHW-SV 
        public const int DS_81XXHX_SH = 2014;   //DVR: DS-81xxHX-SH 
        public const int DS_71XXHX_SL = 2015;   //DVR: DS-71xxHX-SL 
        public const int DS_76XXH_ST = 2016;    //DVR: DS-76xxH-ST 
        public const int DS_73XXHFH_ST = 2017;  //DVR: DS-73xxHFH-ST 
        public const int DS_81XXHFH_ST = 2018;  //DVR: DS-81xxHFH-ST 
        public const int DS_72XXHFH_SL = 2019;  //DVR: DS-72xxHFH-SL 
        public const int DS_FDXXCGA_FLT = 2020; //2盘位ATM  
        public const int IDS_91XX_HF_ST_A = 2100;   //iDS-9100HF-ST/A  
        public const int IDS_91XX_HF_ST_B = 2101;   //iDS-9100HF-ST/B  
        public const int IDS_90XX_HF_ST_A = 2102;   //iDS-9000HF-ST/A  
        public const int IDS_90XX_HF_ST_B = 2103;   //iDS-9000HF-ST/B  
        public const int IDS_81XX_HF_ST_A = 2104;   //iDS-8100HF-ST/A  
        public const int IDS_81XX_HF_ST_B = 2105;   //iDS-8100HF-ST/B  
        public const int IDS_80XX_HF_ST_A = 2106;   //iDS-8000HF-ST/A  
        public const int IDS_80XX_HF_ST_B = 2107;   //iDS-8000HF-ST/B  
        public const int IDS_8104_AHFL_ST = 2108;   //智能混合ATM机  
        public const int IDS_2CD6812F_C = 2109; //垂直双目相机  
        public const int DS_77XXN_ST = 2201;    //Netra NVR: DS-77xxN-ST
        public const int DS_95XX_N_ST = 2202;   //Netra NVR: DS-95xxN-ST
        public const int DS_85XX_N_ST = 2203;   //Netra NVR: DS-85xxN-ST
        public const int DS_96XX_N_XT = 2204;   //Netra NVR: DS-96xxN-XT
        public const int DS_76XX_N_SE = 2205;   //Netra NVR: DS-76xxN-SE、DS-78xxN-SH
        public const int DS_86XXSN_SX = 2206;   //Netra 审讯NVR，包括4种类型：DS-8608SNL-SP、DS-8608SNL-ST、DS-8608SN-SP、DS-8608SN-ST，L表示带LCD，P表POE 
        public const int DS_96XX_N_RX = 2207;   //Netra NVR: DS-96xxN-RX
        public const int DS_96XXX_N_E = 2213;   //高新性能NVR(256路)  
        public const int DS_76XXN_EX = 2214;    //76/78N-EX(/N/P)系列NVR，包括4/8/16路的E1一盘位设备和8/16/32路的E2两盘位设备  
        public const int DS_77XXN_E4 = 2215;    //77N-E4(/N/P)系列NVR，包括8/16/32路设备  
        public const int DS_86XXN_E8 = 2216;    //86N-E8(/N/P)系列NVR，包括8/16/32路设备  
        public const int DS_81XXTHFH_E = 2217;  //DS-8116THFH-E4庭审主机  
        public const int DS_72XXHXH_SH_21 = 2220;   //XVR: 72HGH-SH系列4路 
        public const int DS_72XXHXH_SH_31 = 2221;   //XVR: 72HGH-SH系列8路16路、72HQH-SH系列 
        public const int DS_73XXHXH_SH_31 = 2222;   //XVR: 73HGH-SH系列、73HQH-SH系列 
        public const int DS_81XXHXH_SH_31 = 2223;   //XVR: 81HGH-SH系列、81HQH-SH系列 
        public const int DS_NBXX_N_E1_X = 2226; //便携式主机  
        public const int DS_96XXN_FX = 2230;    //96N-Fx系列NVR，包括8/16/32路设备  
        public const int DS_86XXN_FX = 2231;    //86N-Fx系列NVR，包括8/16/32路设备  
        public const int DS_96XXXN_HX = 2232;   //96xxxN-Hx系列高性能NVR  
        public const int DS_96XXXN_IX = 2237;   //DS-96xxxN-I系列NVR（DS-96128N-I16、DS-96128N-I24、DS-96256N-I16、DS-96256N-I24）  
        public const int PCNVR_IVMS_4200 = 2301;    //iVMS-4200的存储服务器  
        public const int IVMS_6200_TP = 2401;   //IVMS-6200 交通诱导分析仪 
        public const int IVMS_6200_TF = 2402;   //IVMS-6200 交通取证分析仪 
        public const int IVMS_6200_D = 2403;    //iVMS-6200(/D)  
        public const int IDS_81XXAHW_ST = 2405; //iDS-81xxAHW-ST  
        public const int IDS_81XXAHW_SP = 2406; //iDS-81xxAHW-SP  
        public const int IDS_81XXAHWL_ST = 2407;    //iDS-81xxAHWL-ST  
        public const int IDS_81XXAHWL_SP = 2408;    //iDS-81xxAHWL-SP  
        public const int IDS_9616N_H8 = 2409;   //iDS_9616N_H8  
        public const int IVMS_6200_SMD = 2500;  //IVMS_6200_SMD  
        public const int DS_81XXAHW_ST = 2501;  //81HW-ST混合ATM DVR 
        public const int DS_81XXAHW_SP = 2502;  //81HW-SP混合ATM DVR 
        public const int DS_81XXAHWL_ST = 2503; //81AHWL-ST混合ATM DVR 
        public const int DS_81XXAHWL_SP = 2504; //81AHWL-SP混合ATM DVR 
        public const int DS_81XXAHGH_E4 = 2601; //TVI ATM机 
        public const int DS_81XX_SHXL_K4 = 6101;    //KY2017平台审讯机DS-8104SHFH（L）-K4/4P  
        public const int DS_8116THFHL_F4 = 6201;    //标准庭审主机DS-8116THFHL-F4  
        public const int DS_81XXAHQ_E4 = 6301;  //DS_81XXAHQ_E4(TVI ATM) 
        public const int IDS_81XXAHQ_E4 = 6302; //IDS_81XXAHQ_E4(智能TVI ATM) 
        public const int IDS_96XX_NX_S = 7502;  //超脑智能NVR(人体识别)  
        public const int IDS_96XX_NX_V = 7503;  //超脑加油站NVR  
        public const int IDS_96XX_NX_FA = 7504; //人脸超脑智能NVR  
        public const int iDS_PT = 8451; //全景细节相机  
        public const int DS_IEXX_E_J = 11501;   //监所智能服务器  
        public const int IDS_67XX_NX_L = 12502; //67系列录播NVS产品  
        public const int IDS_ENIXX_XHE = 12503;	//录播NVS行业专业产品  

        /*********************定义设备能力集类型************************/
        public const int DEVICE_SOFTHARDWARE_ABILITY = 0x001;   // 设备软硬件能力
        public const int DEVICE_NETWORK_ABILITY = 0x002;        // 设备无线网络能力
        public const int DEVICE_ENCODE_ALL_ABILITY_V20 = 0x008; //设备所有编码能力
        public const int IPC_FRONT_PARAMETER_V20 = 0x009;       // 设备前端参数
        public const int DEVICE_RAID_ABILITY = 0x007;           // 设备RAID能力
        public const int DEVICE_ALARM_ABILITY = 0x00a;          // 设备报警能力
        public const int DEVICE_DYNCHAN_ABILITY = 0x00b;        // 设备数字通道能力
        public const int DEVICE_USER_ABILITY = 0x00c;           // 设备用户管理参数能力
        public const int DEVICE_NETAPP_ABILITY = 0x00d;         // 设备网络应用参数能力
        public const int DEVICE_VIDEOPIC_ABILITY = 0x00e;       // 设备图像参数能力
        public const int DEVICE_JPEG_CAP_ABILITY = 0x00f;       // 设备JPEG抓图能力
        public const int DEVICE_SERIAL_ABILITY = 0x010;         // 设备RS232和RS485串口能力
        public const int DEVICE_ABILITY_INFO = 0x011;           // 设备通用能力类型，具体能力根据发送的能力节点来区分
        public const int STREAM_ABILITY = 0x012;                // 设备流能力集
        public const int MATRIXDECODER_ABILITY = 0x200;         // 多路解码器显示、解码能力
        public const int DECODER_ABILITY = 0x261;               // 解码器XML能力集
        public const int SNAPCAMERA_ABILITY = 0x300;            // 智能交通摄像机能力集
        public const int PIC_CAPTURE_ABILITY = 0x402;           // 抓图图片分辨率能力集
        public const int LED_ABILITY = 0x807;                   // LED能力集
        public const int ACS_ABILITY = 0x801;                   // 门禁能力集
        public const int ALARMHOST_ABILITY = 0x500;             // 报警主机设备能力集

        /*********************定义设备标准能力集类型************************/
        // Smart智能相关能力集
        public const int NET_DVR_GET_SMART_CAPABILITIES = 3500;     //获取Smart能力集	输入：NULL  => SmartCap
        public const int NET_DVR_GET_EVENT_TRIGGERS_CAPABILITIES = 3501;        //获取事件触发能力集	输入：NULL  => EventTriggersCap
        public const int NET_DVR_GET_REGION_ENTRANCE_CAPABILITIES = 3502;       //获取进入区域侦测能力集	输入：4个字节（DWORD）通道号  => RegionEntrance
        public const int NET_DVR_GET_REGION_ENTRANCE_SCHEDULE_CAPABILITIES = 3584;      //获取进入区域侦测布防时间能力集	输入：4个字节（DWORD）通道号  => Schedule
        public const int NET_DVR_GET_REGION_EXITINT_CAPABILITIES = 3511;        //获取离开区域侦测能力集	输入：4个字节（DWORD）通道号  => RegionExiting
        public const int NET_DVR_GET_REGION_EXITING_SCHEDULE_CAPABILITIES = 3585;       //获取离开区域侦测布防时间能力集	输入：4个字节（DWORD）通道号  => Schedule
        public const int NET_DVR_GET_LOITERING_CAPABILITIES = 3520;     //获取徘徊侦测能力集	输入：4个字节（DWORD）通道号  => Loitering
        public const int NET_DVR_GET_LOITERING_SCHEDULE_CAPABILITIES = 3586;        //获取徘徊侦测布防时间能力集	输入：4个字节（DWORD）通道号  => Schedule
        public const int NET_DVR_GET_GROUPDETECTION_CAPABILITIES = 3529;        //获取人员聚集侦测能力集	输入：4个字节（DWORD）通道号  => Group
        public const int NET_DVR_GET_GROUP_SCHEDULE_CAPABILITIES = 3587;        //获取人员聚集侦测布防时间能力集	输入：4个字节（DWORD）通道号  => Schedule
        public const int NET_DVR_GET_RAPIDMOVE_CAPABILITIES = 3538;     //获取快速运动侦测能力集	输入：4个字节（DWORD）通道号  => RapidMove
        public const int NET_DVR_GET_RAPIDMOVE_SCHEDULE_CAPABILITIES = 3588;        //获取快速运动侦测布防时间能力集	输入：4个字节（DWORD）通道号  => Schedule
        public const int NET_DVR_GET_PATKING_CAPABILITIES = 3547;       //获取停车侦测能力集	输入：4个字节（DWORD）网卡号  => Parking
        public const int NET_DVR_GET_PARKING_SCHEDULE_CAPABILITIES = 3589;      //获取停车侦测布防时间能力集	输入：4个字节（DWORD）通道号  => Schedule
        public const int NET_DVR_GET_UNATTENDED_BAGGAGE_CAPABILITIES = 3556;        //获取物品遗留侦测能力集	输入：4个字节（DWORD）通道号  => UnattendedBaggage
        public const int NET_DVR_GET_UNATTENDEDBAGGAGE_SCHEDULE_CAPABILITIES = 3590;        //获取物品遗留侦测布防时间能力集	输入：4个字节（DWORD）通道号  => Schedule
        public const int NET_DVR_GET_ATTENDEDBAGGAGE_CAPABILITIES = 3565;       //获取物品拿取侦测能力集	输入：4个字节（DWORD）通道号  => AttendedBaggageCap
        public const int NET_DVR_GET_ATTENDEDBAGGAGE_SCHEDULE_CAPABILITIES = 3591;      //获取物品拿取侦测布防时间能力集	输入：4个字节（DWORD）通道号  => Schedule
        public const int NET_DVR_GET_REGIONCLIP_CAPABILITIES = 3574;        //获取区域裁剪能力集	输入：NET_DVR_REGION_CLIP_COND  => RegionClip
        public const int NET_DVR_GET_LITESTORAGE_CAPABILITIES = 3596;       //获取轻存储能力集	输入：4个字节（DWORD）通道号  => LiteStorage
        public const int NET_DVR_GET_VEHICLE_CAPABILITIES = 3597;       //获取车俩检测标定能力集	输入：4个字节（DWORD）通道号  => Calibration
        public const int NET_DVR_GET_TRAFFIC_CAP = 6630;        //获取抓拍相关能力集	输入：NULL  => TrafficCap
        public const int NET_DVR_GET_VEHICLLE_RESULT_CAPABILITIES = 3951;       //获取车辆信息查询结果能力集	输入：NULL  => VehicleInfoResultCap
        public const int NET_DVR_GET_COUNTING_CAPABILITIES = 3757;      //获取客流量统计能力集	输入：4个字节（DWORD）通道号  => CountingCap
        public const int NET_DVR_GET_SMARTCALIBRATION_CAPABILITIES = 3900;      //获取Smart行为标定过滤尺寸能力集	输入：4个字节（DWORD）通道号  => SmartCalibrationCap
        // 网络相关能力集
        public const int NET_DVR_GET_NETWORK_CAPABILITIES = 3577;       //获取网络能力集	输入：NULL  => NetworkCap
        public const int NET_DVR_GET_WIRELESSDIAL_CAPABILITIES = 3580;      //获取无线拨号参数能力集	输入：4个字节（DWORD）网卡号  => Dial
        public const int NET_DVR_GET_WIRELESSDIAL_SCHEDULE_CAPABILITIES = 3592;     //获取拨号计划能力集	输入：4个字节（DWORD）网卡号  => Schedule
        public const int NET_DVR_GET_GBT28181_SERVICE_CAPABILITIES = 6505;      //获取GB28181服务器能力集	输入：NULL  => GB28181ServiceCap
        public const int NET_DVR_GET_FTP_CAPABILITIES = 3782;       //获取FTP上传能力集	输入：NULL  => FTPNotificationList
        public const int NET_DVR_GET_WIRELESSSERVER_CAPABILITIES = 3716;        //获取Wifi热点配置能力集	输入：4个字节（DWORD）无线网卡号  => WirelessServer
        public const int NET_DVR_GET_CONNECT_LIST_CAPABILITIES = 3719;      //获取热点连接设备列表信息能力集	输入：4个字节（DWORD）无线网卡号  => accessDeviceList
        public const int NET_DVR_GET_DDNS_COUNTRY_ABILITY = 3800;       //获取设备支持的DDNS国家能力列表	输入：NULL  => DDNSCountry
        public const int NET_DVR_GET_MACFILTER_CAPABILITIES = 3643;     //获取MAC地址过滤配置能力集	输入：NULL  => MACFilter
        public const int NET_DVR_GET_ACTIVATE_IPC_ABILITY = 13003;      //获取NVR激活前端设备能力集	输入：NULL  => VideoSourceActivationCapability
        // 存储相关能力集
        public const int NET_DVR_GET_STORAGEDETECTION_SCHEDULE_CAPABILITIES = 6637;     //获取存储健康检测布防时间能力集	输入：4个字节（DWORD）硬盘号  => Schedule
        public const int NET_DVR_GET_STORAGEDETECTION_RWLOCK_CAPABILITIES = 6647;       //获取存储侦测读写锁配置能力集	输入：NULL  => RWLock
        public const int NET_DVR_GET_STORAGEDETECTION_UNLOCK_CAPABILITIES = 6654;       //获取存储侦测解锁配置能力集	输入：NULL  => UnLock
        public const int NET_DVR_GET_RACM_CAP = 6252;       //获取存储总能力集（RACM能力）	输入：NULL  => RacmCap
        // 外设相关能力集
        public const int NET_DVR_GET_SENSOR_PORT_CAPABILITIES = 5067;       //获取传感器能力集	输入：4个字节（DWORD）通道号  => SensorPortList
        public const int NET_DVR_GET_THSCREEN_CAPABILITIES = 3720;      //获取温湿度配置能力集	输入：4个字节（DWORD）通道号  => THScreen
        public const int NET_DVR_GET_EXTERNALDEVICE_CAPABILITIES = 3722;        //获取外设配置能力集	输入：4个字节（DWORD）通道号  => ExternalDevice
        public const int NET_DVR_GET_SUPPLEMENTLIGHT_CAPABILITIES = 3727;       //获取内置补光灯配置能力集	输入：4个字节（DWORD）通道号  => SupplementLight
        public const int NET_DVR_GET_ACCESSORY_CARD_INFO_CAPABILITIES = 6709;       //获取配件板信息能力集	输入：NULL  => AccessoryCardInfo
        // 其他设备能力集
        public const int NET_DVR_GET_STREAMING_CAPABILITIES = 3712;     //获取视频流能力集	输入：4个字节（DWORD）通道号  => StreamingChannel
        public const int NET_DVR_GET_REFRESHFRAME_CAPABILITIES = 3713;      //获取刷新帧能力集	输入：4个字节（DWORD）通道号  => RefreshFrame
        public const int NET_DVR_GET_OSD_BATTERY_POWER_CFG_CAPABILITIES = 3743;     //获取OSD电池电量显示参数能力集	输入：4个字节（DWORD）通道号  => BatteryPowerOverlay
        public const int NET_DVR_GET_OIS_CAPABILITIES = 3640;       //获取光学防抖参数配置能力集	输入：4个字节（DWORD）通道号  => OIS
        public const int NET_DVR_GET_REVISE_GPS_CAPABILITIES = 3752;        //获取校准GPS经纬度能力集	输入：4个字节（DWORD）通道号  => ReviseGPS
        public const int NET_DVR_GET_ONLINEUPGRADE_ABILITY = 9309;      //获取在线升级能力集	输入：NULL  => OnlineUpgradeCap
        public const int NET_DVR_GET_PTZ_CAPABILITIES = 3619;       //球机PTZ控制能力集	输入：4个字节(DWORD)通道号  => PTZChanelCap
        public const int NET_DVR_GET_EAGLEFOCUS_CALCFG_CAPABILITIES = 3646;     //鹰视聚焦标定配置能力集	输入：4个字节(DWORD)通道号  => EagleFocusing
        public const int NET_DVR_GET_EAGLEFOCUSING_CFG_CAPABILITIES = 3649;     //鹰视聚焦配置能力集	输入：4个字节(DWORD)通道号  => Control
        public const int NET_DVR_GET_SOFTWARE_SERVICE_CAPABILITIES = 3980;      //获取软件服务能力集	输入：4个字节(DWORD)通道号  => SoftwareService
        public const int NET_DVR_GET_SYSTEM_CAPABILITIES = 8100;        //设备系统能力集	输入：NULL  => DeviceCap

        /*********************定义设备配置信息************************/
        // public const int NET_DVR_GET_DEVICECFG_V40 = 1100;  //获取设备参数(扩展)
        // public const int NET_DVR_GET_TIMECFG = 118; //获取时间参数
        public const int NET_DVR_GET_DECODERCFG_V40 = 6319; //获取RS485(云台解码器)参数
        // public const int NET_DVR_GET_RS232CFG_V30 = 1036;   //获取RS232串口参数
        public const int NET_DVR_GET_EXCEPTIONCFG_V40 = 6177;   //获取异常参数
        // public const int NET_DVR_GET_ZONEANDDST = 128;  //获取时区和夏时制参数
        public const int NET_DVR_GET_DEVSERVER_CFG = 3257;  //获取模块服务配置
        public const int NET_DVR_GET_HOLIDAY_PARAM_CFG = 1240;	//获取节假日参数
        ...
        **********************************************************/
        ...
        [DllImportAttribute (@".\HikSDK\HCNetSDK.dll")]
